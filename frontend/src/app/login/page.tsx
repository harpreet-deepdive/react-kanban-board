      ...
      <div className="grid lg:h-screen lg:grid-cols-2">
        <div className="flex items-center justify-center px-4 py-6 lg:py-0 sm:px-0">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full text-white bg-primary-200 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
            >
        ...
        <div className="flex items-center justify-center px-4 py-6 bg-primary-100 lg:py-0 sm:px-0">
          <div className="max-w-md xl:max-w-xl">
            ...
            <h1 className="mb-4 text-3xl font-extrabold leading-none tracking-tight text-white xl:text-5xl">
              Hammer: Where Tasks Meet Efficiency, Every Click Counts.
            </h1>
            <p className="mb-4 font-light text-white lg:mb-8">
              Experience seamless task management like never before. With our
              intuitive interface and powerful features, Hammer simplifies your
              workflow, helping you prioritize, collaborate, and achieve your
              goals effortlessly. Empowering individuals and teams to accomplish
              more, one task at a time
            </p>
